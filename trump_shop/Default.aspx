<%@ Page Language="C#" AutoEventWireup="true" Title="Trang chủ" MasterPageFile="~/Main.master" CodeBehind="Default.aspx.cs" Inherits="trump_shop._Default" %>


<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div>
    <dx:ASPxImage ID="ASPxImage1" runat="server" ShowLoadingImage="true" ImageUrl="~/images/toyshop.jpg" Width="100%"></dx:ASPxImage>
</div>
    <%-- DXCOMMENT: Configure ASPxGridView control --%>
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="True" ClientInstanceName="ASPxGridView1" KeyFieldName="CustomerID" Width="100%" Visible="False">
